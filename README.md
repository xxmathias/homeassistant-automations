...
### Remote Control
- **tuya_button_switch**: 4-button Zigbee remote. Buttons 1+2 toggle the RGB plug, buttons 3+4 turn everything off. The pairs are redundant on purpose. Presses do not count as a manual touch, so they never engage a room hold.
